...
def get_pose3D(video_path, output_dir):
    ...
    args.previous_dir = r'D:\pycharmprojects\PoseFormerV2\checkpoint'
...
if __name__ == "__main__":
    # 手动指定路径和显卡编号
    video_path = r'D:\pycharmprojects\PoseFormerV2\demo\video\segmented11.mp4'
    os.environ["CUDA_VISIBLE_DEVICES"] = '0'  # 可根据需要修改
