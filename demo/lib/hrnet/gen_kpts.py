...
cfg_dir = r'D:\pycharmprojects\PoseFormerV2\demo\lib\hrnet\experiments'
model_dir = r'D:\pycharmprojects\PoseFormerV2\demo\lib\checkpoint'
...
def parse_args():
    ...
    # general
    parser.add_argument('--cfg', type=str, default=os.path.join(cfg_dir, 'w48_384x288_adam_lr1e-3.yaml'),
                        help='experiment configure file name')
    parser.add_argument('opts', nargs=argparse.REMAINDER, default=None,
                        help="Modify config options using the command-line")
    parser.add_argument('--modelDir', type=str, default=os.path.join(model_dir, 'pose_hrnet_w48_384x288.pth'),
...
def gen_video_kpts(video, det_dim=416, num_peroson=1, gen_output=False):
    ...
    print("keypoints shape before transpose:", keypoints.shape)
